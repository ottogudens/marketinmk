...
# Incluir automáticamente dominios de Railway
...
# Railway inyecta DATABASE_URL automáticamente. Fallback a variables individuales.
...
# Cache - usa Redis si está disponible, sino cache en memoria
